...
import '../../../features/onboarding/data/remote_data_sources/settings_onboarding_localdatasource.dart';
import '../../../features/onboarding/data/repo_implementation/onboarding_repositoryImpl.dart';
import '../../../features/onboarding/data/repo_implementation/settings_onboarding_repositoryimpl.dart';
import '../../../features/onboarding/domain/use_cases/get_cardsUseCase.dart';
import '../../../features/onboarding/domain/use_cases/set_onboarding_seenusecase.dart';
...
class RouterGenerationConfig {
  static GoRouter goRouter = GoRouter(
    ...
    redirect: (context, state) {
      try {
        bool hasSeenOnboarding = SharedPrefHelper.instance.getBool(PrefKeys.onboardingSeen) ?? false;

        if (!hasSeenOnboarding && state.uri.toString() != AppRoutes.onBoardingScreen) {
